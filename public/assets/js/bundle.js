...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia3VsdW9uZzIwMDAiLCJhIjoiY2w2YnlzYTY2MGNoMzNibW10djJzMXpkZCJ9.AYjE2JShHUR5aF3xbTJNRQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kuluong2000/cl6ca6uca003615pq17iiaa72',
    // kiểu hiển thị map, được cài đặt từ studio map
  ...
  locations.forEach(function (loc) {
    ...
    console.log(loc.coordinates); // Add popup
...
exports.showAlert = exports.hidelAlert = void 0;

// Type is 'success' or 'error'
var hidelAlert = function hidelAlert() {
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
};

exports.hidelAlert = hidelAlert;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Login in successfully');
...
var userChangePassword = document.querySelector('.form-user-password'); //VALUES
//DELEGATION
//mapbox
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var label = document.getElementById('form-file__label').value;
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]); // label.innerText = 'test';
...
if (userChangePassword) {
  userChangePassword.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              document.querySelector('.btn--password').innerHTML = 'updating password ...';
              _context.next = 7;
